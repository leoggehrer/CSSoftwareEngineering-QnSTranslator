namespace QnSTranslator.Transfer.Modules.Language
{
	using System.Text.Json.Serialization;
	public partial class Translation : QnSTranslator.Contracts.Modules.Language.ITranslation
	{
		static Translation()
		{
			ClassConstructing();
...
namespace QnSTranslator.Transfer.Modules.Account
{
	using System.Text.Json.Serialization;
	public partial class Login : QnSTranslator.Contracts.Modules.Account.ILogin
	{
		static Login()
		{
			ClassConstructing();
