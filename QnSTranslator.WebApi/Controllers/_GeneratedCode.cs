namespace QnSTranslator.WebApi.Controllers
{
	...
	using Contract = Contracts.Persistence.Language.ITranslation;
	using Model = Transfer.Persistence.Language.Translation;
	[ApiController]
	[Route("Controller")]
	public partial class TranslationController : GenericController<Contract, Model>
	{
